...
const PackageForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError('');
            setFormData({ username: '', travel_date: null, num_people: '' });
        } catch (err) {
    ...
    return (
        <div style={{ fontFamily: "'Poppins', sans-serif", padding: '2rem', maxWidth: '600px', margin: '0 auto' }}>
            ...
            >
                ...
                {successMsg && <p style={{ color: 'green', fontWeight: 500 }}>{successMsg}</p>}
            ...
            <style>{`
                ...
                .react-datepicker__day--keyboard-selected {
                    background-color: #0f3535 !important;
                }
            `}</style>
        </div>
    );
