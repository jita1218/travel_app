...
const MyBookingsPage = () => {
  ...
  const handleCancel = async (booking) => {
    ...
    try {
      ...
      // ✅ Update localStorage after cancellation
      const updatedDestinations = updated.map((b) => b.destination?.toLowerCase().trim());
      localStorage.setItem("bookedDestinations", JSON.stringify(updatedDestinations));
    } catch (err) {
